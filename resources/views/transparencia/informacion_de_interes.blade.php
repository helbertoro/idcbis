        ...
        <div class="accordion" id="accordionExample">
            ...
            <div class="card">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionExample">
                    <div class="card-body">
                        <a href="">Estudios, investigaciones y otras publicaciones</a>
                    </div>
                </div>
            </div>
            <div class="card">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                    <div class="card-body">
                        <ul class="list-unstyled">
                            <li>
                                <a target="_blank" href="https://idcbis.org.co/convocatorias-apoyo-financiero/">
                                    <i class="fas fa-external-link-alt"></i> Convocatorias doctorados y maestrías 
                                </a>
                            </li>
                            <li>
            ...
            <div class="card">
                ...
                <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordionExample">
                    <div class="card-body">
                        <ul class="list-unstyled">
                            <li>
                                <a target="_blank" href="https://idcbis.org.co/noticias/">
                                    <i class="fas fa-external-link-alt"></i> Noticias del IDCBIS
                                </a>
                            </li>
                        </ul>
                    </div>
